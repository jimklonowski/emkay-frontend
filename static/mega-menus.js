  ...
  categories: [
    {
      ...
      items: [
        ...
        { key: 'fleet_policies', icon: '', to: { path: '/account/fleet-policies' }, disabled: true },
        ...
        { key: 'manage_enotifications', icon: 'mdi-bell-ring', to: { path: '/account/manage-enotifications' } },
...
export { account, ordering, reporting }

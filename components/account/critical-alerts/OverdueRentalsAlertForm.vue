  ...
  <v-card outlined tile>
    ...
    <v-banner class="caption">
      <v-avatar slot="icon" color="primary" size="40">
        <v-icon icon="mdi-progress-clock" color="white" v-text="'mdi-progress-clock'" />
      </v-avatar>
      <!-- eslint-disable-next-line vue/no-v-html -->
      <span v-html="$t('alert_overdue_rentals_description')" />
    </v-banner>
    <v-card-text v-show="!suppress_alert">
      <!-- eslint-disable-next-line vue/no-v-html -->
      <p class="mb-0" v-html="$t('alert_overdue_rentals_report_description')" />
    </v-card-text>

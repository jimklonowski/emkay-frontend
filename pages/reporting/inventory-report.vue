    ...
    <v-skeleton-loader :loading="$fetchState.pending" type="table" transition="fade-transition">
      ...
      >
        ...
        <template #item.driver_email_address="{ item }">
          <v-btn v-show="item.driver_email_address" text small tile @click="emailTo(item.driver_email_address)">
        ...
        <template #item.driver_mobile="{ item }">
          <v-btn v-show="item.driver_mobile" text small tile @click="dialTo(item.driver_mobile)">
        ...
        <template #item.driver_phone="{ item }">
          <v-btn v-show="item.driver_phone" text small tile @click="dialTo(item.driver_phone)">
